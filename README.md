...
El documento desarrollado incluye un desglose paso a paso alineado con las cláusulas de la norma[cite: 3]:

1. **Introducción y Objetivos:** Justificación del proyecto y metas del SGSI[cite: 2].
2. **Contexto y Alcance (Cláusula 4):** Definición de límites físicos (sucursales locales, áreas restringidas) y virtuales (redes VLAN, entornos cloud)[cite: 1, 3].
3. **Liderazgo y Roles (Cláusula 5):** Matriz de responsabilidades de seguridad para el personal administrativo, de ventas y técnico[cite: 1, 3].
4. **Gestión de Riesgos (Cláusula 6):** Inventario detallado de hardware, software y datos, cruzado con una matriz de priorización de amenazas físicas, ambientales y digitales[cite: 1, 3].
5. **Declaración de Aplicabilidad (Anexo A):** Selección e implementación práctica de controles organizacionales, humanos, físicos y tecnológicos (MFA, firewalls, backups, planes de continuidad)[cite: 1, 3].
6. **Marcos Complementarios:** Integración y sinergia estratégica del SGSI con otros estándares de la industria como **SOC 2, NIST CSF, ITIL v4 y COBIT**[cite: 3].

---

## 🎯 Objetivo Didáctico y de Comunidad
...
## 👤 Autor
* **Damian R. Mejía** - *Desarrollo de documentación e investigación de controles.*[cite: 2]
* Año del Proyecto: 2026[cite: 2]

---

## 📄 Licencia
Este proyecto está bajo la Licencia MIT - lo que significa que eres libre de usar, modificar y distribuir esta documentación para fines educativos, académicos o profesionales.
